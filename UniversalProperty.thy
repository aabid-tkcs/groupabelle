...
section \<open>Universal Property.\<close>
...
text \<open>The following lemma proves that, every function from the generating set S to 
 a group G, extends to a homomorphism from the freegroup generated by S to G.\<close>
...
text\<open>The following theorem proves that if a function f from a generating set S to a
 group G, extends to homomorphims h and g from the freegroup on S to G, then h and g 
are unique upto their restriction on the carrier set of the freegroup. With the 
previous theorem, this suffices to show the existence and uniqueness of 
homomorphism extensions from freegroup S to G. \<close>
...
text\<open>The following lemma states that a group G generated by a set S, satisfies
 the property that given any map f from S to a monoid of the given type,
